        				...
        				<form role='form' method='post' action='userquiz.php'>
            				<div>
                           		...
                           		<div class='form-group'>
                    					<label><?php echo "Question No ". $n .  " : $row[1]"?></label>
               	 					</div>             				
                			</div>
                            
                    				<div class="input-group">
                                    	<input type="radio" name="ans" id="ans" value="a"><?php echo "$row[2]"; ?>
                                    </div>
                                    <div class="input-group">    
                                        <input type="radio" name="ans" id="ans" value="b"><?php echo "$row[3]"; ?>
                                    </div>
                                    <div class="input-group">
                                        <input type="radio" name="ans" id="ans" value="c"><?php echo "$row[4]"; ?>
                                    </div>
                                    <div class="input-group">
                                        <input type="radio" name="ans" id="ans" value="d"><?php echo "$row[5]"; ?>
                                    </div>
